...
from .models import Appointment, Doctor, Especiality, Patient, Testimonial
from .serializers import (AppointmentSerialiazer, DoctorSerialiazer,
                          EspecialitySerialiazer, PatientSerialiazer, TestimonialSerialiazer)
...
class TestimonialListView(ListCreateAPIView):
    permission_classes = (IsAuthenticated,)
    queryset = Testimonial.objects.filter(is_active=True)
    serializer_class = TestimonialSerialiazer
    filter_backends = (
        DjangoFilterBackend,
        SearchFilter
    )
